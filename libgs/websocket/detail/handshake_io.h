...
class LIBGS_WEBSOCKET_TAPI handshake_io_state :
...
class LIBGS_CORE_TAPI handshake_io_operation final : public handshake_io_state<Value,Exec>
{
...
[[nodiscard]] LIBGS_WEBSOCKET_TAPI auto initiate_handshake_io(const Exec &exec, Initiator initiation,
